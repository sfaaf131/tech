...
export default function NotFound() {
  return (
    <div className="grid-bg flex min-h-screen flex-col items-center justify-center px-5 text-center">
      <Logo />
      <p className="mt-10 font-mono text-[11px] tracking-[0.22em] text-copper uppercase">404</p>
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        ...
        <Link href="/enterprise" className="rounded-full border border-line px-5 py-2.5 text-sm">
          Enterprise
        </Link>
      </div>
    </div>
